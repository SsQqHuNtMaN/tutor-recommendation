...
- `start_viewer.bat` / `start_viewer.sh`: maintained Viewer launchers. Windows users normally double-click the repository-root `start_viewer.bat`, which delegates here.
